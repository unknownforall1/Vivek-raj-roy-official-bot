...
from Utils import RAID, EAGLE , HPRAID , RRAID
...
@vk.on(events.NewMessage(incoming=True, pattern=r"/GANGSTER"))
...
async def spam(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(d3vil) == 2:
            ...
            a = await e.client.get_entity(message)
            g = a.id
            username = f"[{GANGSTER}](tg://user?id={g})"
            counter = int(d3vil[0])
            for _ in range(counter):
...
@idk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@ydk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@wdk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@hdk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@sdk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@adk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@bdk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@cdk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@edk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@ddk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@vkk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@kkk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@lkk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@mkk.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@sid.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@shy.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@aan.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@ake.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@eel.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@khu.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@shi.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@yaa.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@dav.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@raj.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@put.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@eag.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@gle.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@wal.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@aaa.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
@boy.on(events.NewMessage(incoming=True, pattern=r"\.randipros"))
async def spam(e):
    usage = "𝗠𝗼𝗱𝘂𝗹𝗲 𝗡𝗮𝗺𝗲 =     eagle\n\nCommand:\n\n.randipros <count> <Username of User>\n\n.randipros <count> <reply to a User>\n\nCount must be a integer."
    if e.sender_id in SMEX_USERS:
        if e.text[0].isalpha() and e.text[0] in ("/", "#", "@", "!"):
            return await e.reply(usage, parse_mode=None, link_preview=None )
        yukki = ("".join(e.text.split(maxsplit=1)[1:])).split(" ", 1)
...
async def _(event):
    ...
    async with event.client.action(event.chat_id, "typing"):
        await event.client.send_message(
            ...
            message="""{}""".format(random.choice(IRAID)),
